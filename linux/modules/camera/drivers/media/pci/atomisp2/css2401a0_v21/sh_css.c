	    ...
	    enum ia_css_irq_type     irq_type)
{
	...
	*/
	...
	ia_css_debug_dtrace(2, "setting irq mask from ia_css_init\n");

	{ /* CSI RX IRQ A controller */
		ia_css_device_store_uint32((hrt_address) 0xC1404, 0xFFFF); /* mask */
		ia_css_device_store_uint32((hrt_address) 0xC140C, 0xFFFF); /* clear */
		ia_css_device_store_uint32((hrt_address) 0xC1410, 0xFFFF);/* enable */
		ia_css_device_store_uint32((hrt_address) 0xC3404, 0xFFFF); /* mask */
		ia_css_device_store_uint32((hrt_address) 0xC340C, 0xFFFF); /* clear */
		ia_css_device_store_uint32((hrt_address) 0xC3410, 0xFFFF);/* enable */
	}

	{ /* Isys_irq_ctrl controller */
		ia_css_device_store_uint32((hrt_address) 0xC8004, 0xffff); /*mask*/
		ia_css_device_store_uint32((hrt_address) 0xC800c, 0xffff); /*clear*/
		ia_css_device_store_uint32((hrt_address) 0xC8010, 0xffff); /*enable*/
	}

	{ /* gpd_irq_ctrl controller */
		uint32_t val;
		val = ia_css_device_load_uint32((hrt_address) 0x504);
		val |= 1 << 20;
		ia_css_device_store_uint32((hrt_address) 0x504, val); /*mask*/
		val = ia_css_device_load_uint32((hrt_address) 0x510);
		val |= 1 << 20;
		ia_css_device_store_uint32((hrt_address) 0x510, val); /*ena*/
	}
    ...
    struct ia_css_frame_info *in_frame)
{
	...
	if (info != NULL) {
		left_cropping = info->sp.left_cropping;
		top_cropping = info->sp.top_cropping;
	}

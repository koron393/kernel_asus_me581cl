...
#define CSS_RX_IRQ_INFO_SINGLE_BIT_PACKET_HEADER_ERR \
	CSS_ID(CSS_RX_IRQ_INFO_SINGLE_BIT_PACKET_HEADER_ERR)
#define CSS_RX_IRQ_MULTI_BIT_PACKET_HEADER_ERR \
	CSS_ID(CSS_RX_IRQ_MULTI_BIT_PACKET_HEADER_ERR)
#define CSS_RX_IRQ_PAYLOAD_CRC_ERR \
	CSS_ID(CSS_RX_IRQ_PAYLOAD_CRC_ERR)
#define CSS_RX_IRQ_FIFO_OVERFLOW \
	CSS_ID(CSS_RX_IRQ_FIFO_OVERFLOW)
#define CSS_RX_IRQ_RESERVED_SHORT_PACKET_DATA_TYPE \
	CSS_ID(CSS_RX_IRQ_RESERVED_SHORT_PACKET_DATA_TYPE)
#define CSS_RX_IRQ_RESERVED_LONG_PACKET_DATA_TYPE \
	CSS_ID(CSS_RX_IRQ_RESERVED_LONG_PACKET_DATA_TYPE)
#define CSS_RX_IRQ_INCOMPLETE_LONG_PACKET_ERR \
	CSS_ID(CSS_RX_IRQ_INCOMPLETE_LONG_PACKET_ERR)
#define CSS_RX_IRQ_FRAME_SYNC_ERROR \
	CSS_ID(CSS_RX_IRQ_FRAME_SYNC_ERROR)
#define CSS_RX_IRQ_LINE_SYNC_ERROR \
	CSS_ID(CSS_RX_IRQ_LINE_SYNC_ERROR)
#define CSS_RX_IRQ_DPHY_SOT_ERR \
	CSS_ID(CSS_RX_IRQ_DPHY_SOT_ERR)
#define CSS_RX_IRQ_DPHY_SYNC_ERR \
	CSS_ID(CSS_RX_IRQ_DPHY_SYNC_ERR)
#define CSS_RX_IRQ_ESC_MODE_ERR \
	CSS_ID(CSS_RX_IRQ_ESC_MODE_ERR)
#define CSS_RX_IRQ_ESC_MODE_TRIGGER_EVENT \
	CSS_ID(CSS_RX_IRQ_ESC_MODE_TRIGGER_EVENT)
#define CSS_RX_IRQ_ESC_MODE_ULPS_FOR_DATA \
	CSS_ID(CSS_RX_IRQ_ESC_MODE_ULPS_FOR_DATA)
#define CSS_RX_IRQ_ESC_MODE_ULPS_EXIT_FOR_CLOCK \
	CSS_ID(CSS_RX_IRQ_ESC_MODE_ULPS_EXIT_FOR_CLOCK)

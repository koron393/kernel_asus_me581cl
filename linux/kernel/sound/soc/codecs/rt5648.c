...
static const struct snd_kcontrol_new rt5648_snd_controls[] = {
	...
	SOC_SINGLE("ALC Noise Gate Switch", RT5648_ALC_CTRL_4, 13, 1, 0),
	/* ALC Limiter Threshold Control*/
	SOC_SINGLE("ALC Threshold Control", RT5648_ALC_CTRL_4, 0, 31, 0),
	/* DRC Enable Control */
	SOC_SINGLE("DRC Enable Control", RT5648_ALC_CTRL_1, 14, 3, 0),
	/* DRC Sample Rate Control */
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		switch (project) {
			case 0x00:
			case 0x07:
				rt5648_update_eqmode(codec, EQ_CH_DACL, ME581CL_SPK_LEFT);
				rt5648_update_eqmode(codec, EQ_CH_DACR, ME581CL_SPK_RIGHT);
				break;
		}
			...
			enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_OFF:
		...
		if ((hs_get_status() & SND_JACK_HEADSET) == SND_JACK_HEADSET) {
			...
			snd_soc_write(codec, RT5648_PWR_ANLG1, 0x281a);
